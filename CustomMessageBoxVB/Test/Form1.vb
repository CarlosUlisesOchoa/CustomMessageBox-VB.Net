Public Class Form1
    ...
    Private Sub btnInputDateTest_Click(sender As Object, e As EventArgs) Handles btnInputDateTest.Click

        Dim res As Date = CustomInputDate.Show("This is an example of a Message Box", "Warning-Exclamation Icon", MessageBoxButtons.OKCancel, MessageBoxIcon.Information, MessageBoxDefaultButton.Button1)

        MsgBox(res.ToString("dd/MM/yyyy"))
